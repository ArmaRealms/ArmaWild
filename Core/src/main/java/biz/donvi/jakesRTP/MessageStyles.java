...
//        String box = "┏╍┓┃┗╍┛";
    ...
    enum DebugDisplayLines {
        ...
        DebugDisplayLines(final int numPlaceholders) {
        ...
        String format(final boolean mcFormat, final Object... args) {
