...
public final class GeneralUtil {
     ...
     */
    public static String locationAsString(final Location loc, final int decimalPlaces, final boolean forceDecimal) {
        final double[] pos = {loc.getX(), loc.getY(), loc.getZ()};
     ...
     */
    public static String stringOf(final char c, final int times) {
        if (times <= 0) return "";
     ...
     */
    public static String worldToProperCase(final Server server, final String worldName) {
    ...
    public static World getWorldIgnoreCase(final Server server, final String worldName) {
        final List<World> worldList = server.getWorlds();
        for (final World world : worldList)
            if (world.getName().equalsIgnoreCase(worldName))
                return world;
    ...
    public static String replaceWrittenLineBreaks(final String s) {
        return
    ...
    public static String replaceLegacyColors(final String s) {
        return
    ...
    public static String replaceNewColors(final String s) {
        return
